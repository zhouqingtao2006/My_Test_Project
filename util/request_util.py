...
def http_client(url, api_name, method, data, headers=None, cookies=None):
    ...
    if method.lower() == "get":
        ...
        response = requests.options(url + "/%s/" % api_name, cookies=cookies)
    elif method.lower() == "put":
        response = requests.put(url + "/%s/" % api_name + '/put', data=data, cookies=cookies)
    elif method.lower() == "delete":
        response = requests.put(url + "/%s/" % api_name + '/delete', data=data, cookies=cookies)
    elif method.lower() == "patch":
        response = requests.put(url + "/%s/" % api_name + '/patch', data=data, cookies=cookies)
    else:
